...
class VerifyCodeSign extends StatelessWidget {
  const VerifyCodeSign({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: AppColor.background,
       floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {    Get.defaultDialog(
              title: "Attention", middleText: "Test Account \n Test OTP : 33333 ");;},child: Icon(Icons.info,color: Colors.white,)),
      appBar: AppBar(
        backgroundColor: AppColor.background,
        centerTitle: true,
        title: Text(
      ...
      body: GetBuilder<VerifyCodeSignControllerImp>(
        builder: (controller) =>
         HandelingViewReq(
                  ...
                  child: ListView(
                    children: [
                      ...
                      OtpTextField(
                        ...
                        onSubmit: (String verificationCode) => controller
                            .checkCode(verificationCode), // end onSubmit
                      ),
